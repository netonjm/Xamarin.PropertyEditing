...
namespace Xamarin.PropertyEditing.Tests.MockPropertyInfo
{
	...
	public class MockEnumPropertyInfo<TUnderlying, TEnum>
		...
		where TEnum : struct
	{
		public MockEnumPropertyInfo (string name, string description = null, string category = "", bool canWrite = true, bool flag = false, IEnumerable<Type> converterTypes = null, PropertyVariation[] variations = null)
